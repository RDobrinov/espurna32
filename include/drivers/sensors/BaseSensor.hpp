...
// -----------------------------------------------------------------------------
#ifndef INC_BASESENSOR_HPP
#define INC_BASESENSOR_HPP
...
class BaseSensor {
    ...
    public:
	    ...
	    virtual signed char decimals(unsigned char type);
        ...
        void onEvent(TSensorCallback fn);
        TSensorCallback getCallback();
