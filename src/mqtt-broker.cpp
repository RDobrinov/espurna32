...
#ifndef INC_MQTT_BROKER_HPP
#define INC_MQTT_BROKER_HPP
...
void mqttSetup() {
    ...
    // Main callbacks
    espurna32RegisterLoop(mqttLoop);
    espurna32RegisterReload(_mqttConfigure);
